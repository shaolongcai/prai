  ...
  Buffer.prototype.write = function write(string, offset, length, encoding) {
    ...
    for (;;) {
      switch (encoding) {
        ...
        case 'utf16le':
        case 'utf-16le':
          return ucs2Write(this, string, offset, lengthfunction createCommonjsModule(fn, module) {
...
var buffer$1 = createCommonjsModule(function (module, exports) {
  ...
  Buffer.isBuffer = function isBuffer(b) {
    return b != null && b._isBuffer === true && b !== Buffer.prototype; // so Buffer.isBuffer(Buffer.);
