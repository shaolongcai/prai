ed from the main Node.js thread or the id of a
     * worker thread.
...
declare module 'v8' {
     ...
     * generated, where `{pid}` will be the PID of the Node.js process, `{thread_id}` will be `0` when `writeHeapSnapshot()` is call, one last coverage will still be written to
