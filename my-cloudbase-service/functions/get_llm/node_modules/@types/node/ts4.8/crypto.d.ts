...
declare module 'crypto' {
    ...
    class Hash extends stream.Transform {
         ...
         * If `encoding` is provided a string will be returned; otherwi 5208](https://www.rfc-editor.org/rfc/rfc5208.txt) for PKCS#8 encryption and [RFC 1421](https://www.rfc-editor.org/rfc/rfc1421.txt) for
