 500" to "Resolve only if the status code is less than 500"
...
- Improving HTTP adapter to ret# Changelog
...
- Update README.md about validateStatus ([#2912](https://github.com/axios/axios/pull/2912))
  Rewrote the comment from "Reject only if the status code is greater than or equal tourn last request in case of redirects ([#828](https://github.com/axios/axios/pull/828))
