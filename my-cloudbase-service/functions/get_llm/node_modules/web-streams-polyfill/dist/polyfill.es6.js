rn promiseRejectedWith(defaultReaderBrandCheckException('closed'));
            }
...
(function (global, factory) {
    ...
    class ReadableStreamDefaultReader {
        ...
        get closed() {
            if (!IsReadableStreamDefaultReader(this)) {
                retuull. An underlying byte source ought to use this information to determine when and how to apply backpressure.
         */
        get desiredSize() {
            if (!IsReadableByteStreamController(this)) {
