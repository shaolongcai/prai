...
class ReadableStreamDefaultReader {
     ...
     * If the associated stream is errored when the lock is released, the reader will appear e    this._pendingPullIntos.push(pullIntoDescriptor);
        }
